...
class UIBase(ABC):
    ...
    async def send_diff(self, file_path: str, old_content: str, new_content: str):
        """Send a diff of file changes to the UI."""
        pass

    @abstractmethod
    async def send_stream(self, content: str):
        """Send content to the Stream tab."""
        pass

    @abstractmethod
    async def send_testing_instructions(self, instructions: str):
        """Send testing instructions to the Testing Instructions tab."""
        pass

    @abstractmethod
    async def send_server_logs(self, logs: str):
        """Send server logs to the Server Logs tab."""
        pass

    @abstractmethod
    async def send_app_progress(self, progress: str):
        """Send app progress to the App Progress tab."""
        pass

    @abstractmethod
    async def send_deployment_info(self, info: str):
        """Send deployment information to the Deployments tab."""
        pass
